...
// http://mad-dog.ru/update-gulp-v4/
// Асинхронное завершение
// Ошибка следующая:

// The following tasks did not complete: default, del
// Did you forget to signal async completion?CopyЭта ошибка возникает при использовании анонимной функции (та, которая вызывается после del в примере).
